import {BaoMasterFarmer, Deposit, Withdraw} from '../generated/BaoMasterFarmer/BaoMasterFarmer'
...
function handleEvent(pid: BigInt, userAddrs: Address, contractAddrs: Address): void {
  let baoMasterFarmer = BaoMasterFarmer.bind(contractAddrs);
  let pool = baoMasterFarmer.poolInfo(pid);
  ...
  lp.balance = convertTokenToDecimal(baoMasterFarmer.userInfo(pid, userAddrs).value0, BI_18)
  lp.pendingReward = convertTokenToDecimal(baoMasterFarmer.pendingSushi(pid, userAddrs), BI_18)
  lp.save()
}
